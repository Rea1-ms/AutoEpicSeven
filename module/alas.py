...
class AzurLaneAutoScript:
    ...
    def run(self, command):
        try:
            ...
            logger.warning('If you are playing by hand, please stop AES')
            self.config.task_call('Restart')
            ...
            logger.warning(e)
            self.save_error_log()
            logger.warning('An error has occurred in Epic Seven game client, AES is unable to handle')
            ...
            if self.checker.is_available():
                ...
                handle_notify(
                    ...
                    title=f"AES <{self.config_name}> crashed",
