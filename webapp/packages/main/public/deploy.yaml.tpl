Deploy:
  Git:
    # URL of AutoEpicSeven repository
    # [CN user] Use 'cn' to get update from git-over-cdn service
    # [Other] Use 'global' to get update from https://github.com/Rea1-ms/AutoEpicSeven
  ...
  Python:
    ...
    # [Other] Use you own python, and its version should be 3.10.19 64bit
