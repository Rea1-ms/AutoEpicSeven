...
from tasks.knights_v2.expedition import KnightsExpeditionMixin
from tasks.knights_v2.support import KnightsV2SupportMixin
from tasks.knights_v2.weekly_task import KnightsV2WeeklyTaskMixin
from tasks.knights_v2.world_boss import KnightsV2WorldBossMixin


class KnightsV2(
    KnightsV2WorldBossMixin,
    KnightsExpeditionMixin,
    KnightsV2SupportMixin,
    KnightsV2WeeklyTaskMixin,
    UI,
):
    ...
    def _claim_weekly_rewards(self, skip_first_screenshot=True) -> bool:
        logger.info("Knights v2: claim weekly rewards")
    ...
    def run(self) -> bool:
        ...
        if not any(
            ...
            logger.warning("Knights v2: all sub tasks disabled")
